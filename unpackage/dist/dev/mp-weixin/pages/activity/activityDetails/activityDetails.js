...
var _activityDetails = _interopRequireDefault(__webpack_require__(/*! ./pages/activity/activityDetails/activityDetails.vue */ 376));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _activityDetails_vue_vue_type_template_id_f7873272_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./activityDetails.vue?vue&type=template&id=f7873272&scoped=true& */ 377);
/* harmony import */ var _activityDetails_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./activityDetails.vue?vue&type=script&lang=js& */ 379);
...
/* harmony import */ var _activityDetails_vue_vue_type_style_index_0_id_f7873272_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./activityDetails.vue?vue&type=style&index=0&id=f7873272&lang=scss&scoped=true& */ 381);
  ...
  onLoad: function onLoad(options) {var _this2 = this;
    ...
    then(function (resp) {
      ...
      if (resp.status == 200) {
        ...
        _this2.endTime = resp.data.endTime;
        _this2.lat = resp.data.lat;
        _this2.long = resp.data.lon;
        _this2.venueName = resp.data.venueName;
        _this2.address = resp.data.address;
        _this2.organizerPhone = resp.data.phone;
        _this2.clubId = resp.data.clubId;
        _this2.state = resp.data.osStateId;
        var _endTime = new Date(_this2.endTime.replace(/-/g, '/')).getTime() / 1000;
        _this2.countdowm(_endTime); //执行倒计时函数
      }
    });
    // 获取报名列表
    this.$http.get({
          ...
          then(function (resp) {
            ...
            if (resp.status == 200) {
              if (resp.data.initClubMember) {//已加入俱乐部
                if (_this3.isChecked) {//已同意免责条款
                  uni.navigateTo({
                    url: '/pages/activity/pay/pay?actId=' + _this3.activityId });
